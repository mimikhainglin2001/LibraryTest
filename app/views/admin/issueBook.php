            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-blue-900 text-white sticky top-0 z-10">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white-500 uppercase tracking-wider">Borrow Date</th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white-500 uppercase tracking-wider">Due Date</th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white-500 uppercase tracking-wider">Renew Date</th>
