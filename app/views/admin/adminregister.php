    ...
    <div class="main-container">
        ...
        <div class="right-section">
            ...
            <form method="post" action="<?php echo URLROOT; ?>/auth/adminRegister">
                ...
                <input type="department" name="department" placeholder="Department" required class="form-input" />
                ...
                <!-- Google reCAPTCHA -->
                <div class="g-recaptcha my-2" data-sitekey="6LcgC6srAAAAALsBkoG1fkh0WkvgKh87AlkDBrDW"></div>
                ...
                <div class="login-link">
                    <p>
                        ...
                        <a href="<?php echo URLROOT; ?>/pages/login" class="text-blue-600 font-medium">Login here</a>
                    </p>
                </div>
            </form>
        </div>
